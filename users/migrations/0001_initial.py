    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrateur'), ('seller', 'Vendeur'), ('client', 'Client')], default='client', max_length=10)),
                ('whatsapp_number', models.CharField(blank=True, help_text='Numéro WhatsApp pour les vendeurs', max_length=20, null=True)),
